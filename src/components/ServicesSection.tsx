...
export function ServicesSection() {
  return (
    <section className="bg-black py-16 md:py-32 overflow-x-hidden">
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        ...
        >
          ...
          <p className="text-white/50 text-lg">
            From research to production, we deliver intelligent systems that scale.
          </p>
        </motion.div>
        ...
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            ...
            >
            <Card className="relative w-full flex overflow-hidden bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="mx-auto block w-fit text-5xl text-white">AI</span>
                </div>
                <h2 className="mt-6 text-center text-3xl text-white">Research-Driven</h2>
              </CardContent>
            </Card>
            </motion.div>
            ...
            >
            <Card className="relative w-full h-full overflow-hidden bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-white/10 before:border-white/5">
                  <Shield className="m-auto h-16 w-16 text-white" strokeWidth={1} />
                </div>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-white/10 before:border-white/5">
                    <Brain className="m-auto size-6 text-white" strokeWidth={1} />
                  </div>
            ...
            <Card className="relative w-full h-full overflow-hidden bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-white/10 before:border-white/5">
                    <svg className="m-auto size-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
                ...
                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs text-white/70">Computer Vision</span>
                      <div className="ring-black size-7 ring-4 bg-blue-500 rounded-full flex items-center justify-center">
                        <Code className="size-3 text-white" strokeWidth={2} />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-black size-8 ring-4 bg-purple-500 rounded-full flex items-center justify-center">
                        <Database className="size-4 text-white" strokeWidth={2} />
                      </div>
                      <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs text-white/70">Neural Networks</span>
                    </div>
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs text-white/70">NLP</span>
                      <div className="ring-black size-7 ring-4 bg-green-500 rounded-full flex items-center justify-center">
